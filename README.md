...
Use numbered headings such as `第十一章`, `Chapter 11`, or `Chương 11`. Numbered
...
supported. The exact RAW exporter form `Chapter N: 第N章 <title>` followed by decorative
...
handled by the same title-matching rule, including truncated parenthetical notes.
